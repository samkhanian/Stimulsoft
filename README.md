...
| **مخاطب** | معمار نرم‌افزار،تیم فرونت، تیم بک‌اند، مدیر فنی، تیم BI |
...
برای درک کامل و پیاده‌سازی این سیستم، اسناد زیر را به ترتیب مطالعه کنید:

1. **انتخاب معماری (همین سند):** تحلیل چرا معماری هیبریدی بهترین انتخاب برای Stimulsoft است.
2. **استراتژی فنی هیبرید:** [MODERN_HYBRID.md](./MODERN_HYBRID.md) - جزئیات فنی Angular/.NET و استراتژی محاسبات سه‌لایه.
3. **پروژه نمونه:** [PROJECT_PROPOSAL.md](./PROJECT_PROPOSAL.md) - پیاده‌سازی عملی در قالب پروژه "دفتر معین هوشمند".
